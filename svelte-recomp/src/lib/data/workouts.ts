export interface Exercise {
  name: string; muscle: string; w1: string; w2: string;
  rest: string; tip: string; yt: string; vid: string;
}
...
export interface ScheduleDay {
  day: string; sess: string | null; note: string;
}

export const workoutSchedule: ScheduleDay[] = [
...
export const workoutSessions: Record<string, Session> = {
  A: {
